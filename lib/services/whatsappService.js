...
export const whatsappService = {
     ...
     */
    async sendOrderNotification(userId, orderId) {
        console.log(`[WhatsApp Service] Initiating notification flow for order ${orderId} (user: ${userId})...`);
        ...
        try {
            ...
            const templateName = user.wa_template_name || 'order_confirmation';
    ...
    formatPhoneNumber(phone) {
        ...
        if (cleaned.startsWith('0')) {
            // Default Pakistan regional prefix
